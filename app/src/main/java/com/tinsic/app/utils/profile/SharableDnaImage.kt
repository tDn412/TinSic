package com.tinsic.app.utils.profile
...
import com.tinsic.app.presentation.profile.RadarChart
import com.tinsic.app.presentation.profile.TopItemsList
...
fun SharableDnaImage(dnaProfile: MusicDnaProfile, user: User) {
    ...
    Box(
        ...
        Column(
            ...
            // 1. Header
            Text("Music DNA của ${user.displayName}", color = Color.White, fontSize = 24.sp, fontWeight = FontWeight.Bold)
